...
class Game:
    ...
    def end_game(self):
        ...
        print(f'{self.player}({self.player.score}) vs {self.pc}({self.pc.score})'.center(72))
        print(''.center(72, '='))
        print()
...
def get_args():
    ...
    parser.add_argument("-r", "--rounds", type=int, help="How many rounds to play", required=False)
    parser.add_argument("-g", "--gui", action='store_const', default=False, const=True, help="Display images")
